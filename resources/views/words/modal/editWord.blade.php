...
@csrf
        @method('PUT')
            ...
            <div class="modal-body">
                ...
                <div class="mt-3">
                    <a class="btn btn-default" id="btnmore" data-bs-toggle="collapse" href="#collapseWord" role="button" aria-expanded="false" aria-controls="collapseExample" onclick="this.style.display='none'" style="display: inline;"><i class="icon-dots"></i> Eщё</a>
