...
@csrf
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalToggleLabel">Добавить группу слов</h5>
        ...
        <div class="modal-body"><br>
            ...
            <div class="input-group">
                <input class="form-control" id="inputwords" name="name" placeholder="Введите название группы слов" value="" required>
                <div class="dropdown">
