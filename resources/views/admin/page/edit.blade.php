...
@section('content')
    <form method="POST" action="{{route('infopage.update')}}">
        @csrf
        {{ method_field('PUT') }}
    <div class="container">
    <h3 class="mt-3 fw-bold">Изменить страницу</h3>
    <a class="btn btn-light mt-3" data-bs-toggle="collapse" href="#meta-collapse" role="button" aria-expanded="false" aria-controls="collapseExample"> <i class="fas fa-search" title="Поля мета-данных"></i></a>
        ...
        <div class="card card-body mt-3">
            ...
            <div class="mb-3 mt-4">
                ...
                <div class="input-group validate_url">
                    ...
                    <span id="addurl" class="input-group-addon btn btn-light" data-sistem="0" data-ext=".html" onclick="makeUrl(this)" ><i class="fa fa-lock"></i></span>
                </div>
    ...
    <script type="text/javascript">
        var ckeditor = CKEDITOR.replace('content'); AjexFileManager.init({returnTo: 'ckeditor',editor: ckeditor1});
    </script>
@endsection
