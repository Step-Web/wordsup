...
@section('content')
    <form method="POST" action="{{route('infopage.store')}}">
        @csrf
    <div class="container">

    <h3 class="mt-3 fw-bold">Добавить страницу</h3>
    ...
    <a class="btn btn-light mt-3" data-bs-toggle="collapse" href="#meta-collapse" role="button" aria-expanded="false" aria-controls="collapseExample"> <i class="fas fa-search" title="Поля мета-данных"></i></a>
        ...
        <p class="text-center m-3"><button type="submit" class="btn btn-dark btn-lg">Добавить</button></p>
    </form>
