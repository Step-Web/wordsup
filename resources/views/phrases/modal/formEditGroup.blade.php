...
@csrf
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalToggleLabel">Изменить группу фраз</h5>
        ...
        <div class="modal-body"><br>
            ...
            <div class="input-group">
                <input class="form-control" id="inputwords" name="name" placeholder="Введите название группы" value="{{$group->name ?? ''}}" required>
                <div class="dropdown">
